...
INTENT_TRAINING = {
    ...
    "traffic_live": [
        ...
        "anlik akislar",
        "canli akislar",
        "su an hangi baglantilar var",
        "aktif flow lar",
        "trafik akisi goster",
        "canli baglanti listesi",
    ],
    "traffic_large": [
        "buyuk transferler",
        "buyuk indirmeler",
        "agir veri akislari",
        "buyuk dosya transferleri",
        "1 mb ustu transferler",
        "buyuk yuklemeler",
        "en buyuk transferler",
    ],
    "device_traffic": [
        "cihaz trafigi",
        "cihazin trafigi",
        "bu cihazin trafigi",
        "veri kullanimi",
        "cihazin veri kullanimi",
        "babamin telefonunun trafigi",
        "su cihazin trafik ozeti",
        "cihaz baglantilari",
    ],
    "ddos_status": [
        "ddos durumu",
        ...
        "ddos saldirisi",
        "ddos istatistikleri",
        "ddos engelleme durumu",
        "ddos koruma aktif mi",
        "ddos bilgileri",
    ],
    "dhcp_leases": [
        "dhcp kiralamalari",
    ...
    "dhcp_reserve": [
        ...
        "statik ip ata",
        "sabit ip atamasi",
        "dhcp rezervasyonu olustur",
        "mac adresine ip bagla",
        "sabit kiralama ekle",
        "ip yi bu mac e bagla",
    ],
    "dhcp_delete_reservation": [
        "rezervasyonu sil",
        "statik atamayi kaldir",
        "sabit ip atamasini sil",
        "dhcp rezervasyonunu kaldir",
        "statik kiralama sil",
        "rezervasyon iptal",
    ],
    "create_profile": [
        ...
        "yeni profil olustur",
        "profil ekle",
        "misafir profili olustur",
    ],
    "update_profile": [
        "profil guncelle",
        "profil bandwidth degistir",
        "profilin hizini degistir",
        "profil ayarlarini degistir",
        "profil limiti guncelle",
        "profil duzenleme",
    ],
    "delete_profile": [
        "profil sil",
    ...
    "device_dns_queries": [
        "cihazin dns sorgulari",
        "hangi sitelere girdi",
        "cihazin sorgu gecmisi",
        "bu cihaz hangi sitelere girdi",
        "cihazin ziyaret ettigi siteler",
        "dns sorgu gecmisi",
        "babamin telefonunun dns sorgulari",
        "su cihazin gezinti gecmisi",
    ],
    "system_reboot": [
        "sistemi yeniden baslat",
        "reboot yap",
        "sistem yeniden baslatma",
        "router i yeniden baslat",
        "cihazi yeniden baslat",
        "reboot",
        "restart yap",
    ],
    "service_block": [
        "youtube servisini engelle",
        "servisi kapat",
        "cihazda servisi engelle",
        "bu cihazda youtube servisi kapatilsin",
        "netflix servisini engelle",
        "servis engelleme",
        "cihaz servis engelle",
    ],
    "service_unblock": [
        "youtube servisini ac",
        "servis engelini kaldir",
        "cihazda servis ac",
        "bu cihazda youtube servisi acilsin",
        "netflix servisini serbest birak",
        "servis engeli kaldir",
        "cihaz servis ac",
    ],
    "service_usage": [
        "youtube u hangi cihazlar kullaniyor",
        "youtube kullanan cihazlar",
        "netflix i kim kullaniyor",
        "whatsapp kullanan cihazlari goster",
        "youtube izleyen cihazlar",
        "instagram kullanan var mi",
        "hangi cihazlar youtube kullaniyor",
        "su an youtube acik mi",
        "tiktok kullanan cihaz",
        "spotify dinleyen kim",
    ],
    "query_logs": [
        "loglar",
        "loglari goster",
